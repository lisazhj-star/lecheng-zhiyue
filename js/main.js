...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var courseData = {
        ...
        "选人·高效面试工作坊": {
            badge: "talent",
            label: "人才发展",
            desc: "面向业务管理者与面试官：用华为选人方法建立从需求定义到入职带教的九步闭环，问到事实、看清本质。",
            duration: "4-8小时",
            size: "25人以内",
            target: "业务管理者、招聘负责人、面试官",
            method: "实训工作坊 + 场景演练 + 工具落地",
            objectives: [
                "完成三个转变：从\"等HR招人\"到\"我是用人第一责任人\"、从\"凭感觉聊天\"到\"用证据判断\"、从面试到带教闭环",
                "掌握人才画像三层结构：硬门槛 / 软素质 / 反指标",
                "掌握结构化面试设计与 STAR 行为面试 + 五层追问漏斗",
                "用公司七维素质标尺统一选人标准，与HR形成协同"
            ],
            topics: ["选错一个人的真实代价", "华为的选人教训", "选人是业务的责任", "选人全景地图九步闭环", "行为是最佳预测器", "七维素质定义", "JD三问定义需求", "人才画像画布三层结构", "分岗画像要点", "10秒简历扫描法", "结构化面试设计表", "STAR行为面试", "五层追问漏斗", "3F探寻真实动机", "雇主品牌与面试开场", "候选人评估与决策"],
            outcomes: [
                "带走一套人才画像画布与结构化面试题本",
                "掌握STAR五层追问，识别简历包装",
                "与HR形成\"需求-面试-带教\"闭环"
        ...
        "一线管理者·如何选人工作坊": {
            badge: "talent",
            label: "人才发展",
            desc: "面向生产一线管理者：从岗位画像到STAR面试与学习敏锐度评估，破解\"招不来、留不住\"。",
            duration: "4-8小时",
            size: "25人以内",
            target: "一线管理者、班组长、车间主管",
            method: "工作坊 + 角色扮演 + 行动计划",
            objectives: [
                "会构建岗位画像：能力要求 + 性格特质 + 价值观匹配",
                "掌握 STAR 面试法与三层递进追问，剥离简历包装",
                "用六看筛选法与 3F 探寻法识别真实动机与稳定性",
                "用学习敏锐度五维评估候选人长期潜力"
            ],
            topics: ["制造业人才缺口与选人挑战", "识人先识岗：岗位画像构建", "岗位画像三要素", "核心能力与关键性格特质", "价值观匹配点", "STAR面试法", "三层递进追问", "六看筛选法", "3F探寻法（Fact/Feeling/Focus）", "学习敏锐度五维评估", "高敏锐度vs低敏锐度行为特征", "候选人评估与决策", "个人招聘行动计划"],
            outcomes: [
                "现场产出一份目标岗位画像",
                "完成一轮STAR面试模拟并获反馈",
                "制定个人招聘行动计划"
